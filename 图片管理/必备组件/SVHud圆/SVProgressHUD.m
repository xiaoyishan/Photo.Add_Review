...
//    [[self sharedView] showProgress:1 status:str maskType:SVProgressHUDMaskTypeNone];
    [self showImage:nil status:str];
}
+ (void)showWithBlackColor{
...
- (id)initWithFrame:(CGRect)frame {
    ...
    if ((self = [super initWithFrame:frame])) {
        ...
        SVProgressHUDBackgroundColor = [UIColor colorWithWhite:0.1000 alpha:0.9000];
...
//    BOOL imageUsed = (self.imageView) || (self.imageView.hidden);
